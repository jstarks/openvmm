...
mod tests {
    ...
    fn test_add_in_order() {
        ...
        assert_eq!(r, AddResult { consumed: 10, fin: false });
        assert_eq!(a.ranges(), &[]);
        assert!(a.is_empty());
    }
    ...
    fn test_add_single_ooo() {
        ...
        assert_eq!(r, AddResult { consumed: 0, fin: false });
    ...
    fn test_fill_gap() {
        ...
        let r = a.add(0, 10, false).unwrap();
        assert_eq!(r, AddResult { consumed: 15, fin: false });
        assert_eq!(a.ranges(), &[]);
    }
    ...
    fn test_fill_middle_gap() {
        ...
        assert_eq!(r, AddResult { consumed: 5, fin: false });
    ...
    fn test_fill_middle_gap_no_intervening_consume() {
        ...
        assert_eq!(r, AddResult { consumed: 25, fin: false });
        assert_eq!(a.ranges(), &[]);
    }
    ...
    fn test_merge_all() {
        ...
        assert_eq!(r, AddResult { consumed: 18, fin: false });
        assert_eq!(a.ranges(), &[]);
    }
    ...
    fn test_consume_with_remaining() {
        ...
        assert_eq!(r, AddResult { consumed: 8, fin: false });
    ...
    fn test_fin_in_order() {
        ...
        assert_eq!(r, AddResult { consumed: 10, fin: true });
        assert_eq!(a.ranges(), &[]);
    ...
    fn test_fin_not_yet() {
        ...
        // Fill the rest.
        let r = a.add(0, 15, false).unwrap();
        assert_eq!(r, AddResult { consumed: 15, fin: true });
        assert_eq!(a.ranges(), &[]);
        assert_eq!(a.fin_offset, None);
    }
    ...
    fn test_fin_pure_no_data() {
        ...
        assert_eq!(r, AddResult { consumed: 0, fin: true });
        assert_eq!(a.fin_offset, None);
    }
