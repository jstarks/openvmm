...
pub async fn open_vhdx_chain(
    ...
    loop {
        ...
        let vhdx = vhdx::VhdxFile::open_read_only(bf, &vhdx::OpenOptions::new())
            .await
...
fn resolve_parent_path(
    child_dir: &Path,
    parent_paths: &vhdx::locator::ParentPaths,
