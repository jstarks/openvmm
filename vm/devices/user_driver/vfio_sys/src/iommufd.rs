...
#[repr(C)]
pub struct IommuGetHwInfo {
    pub size: u32,
    pub flags: u32,
    pub dev_id: u32,
    pub data_len: u32,
    pub data_uptr: u64,
    pub out_data_type: u32,
    pub out_max_pasid_log2: u8,
    pub __reserved: [u8; 3],
    pub out_capabilities: u64,
}
...
#[repr(C)]
pub struct IommuHwptInvalidate {
    pub size: u32,
    pub hwpt_id: u32,
    pub data_uptr: u64,
    pub data_type: u32,
...
/// ARM SMMUv3 cache invalidation command (raw 128-bit CMDQ entry).
///
/// Passed as an array element via `data_uptr` with
/// `data_type == IOMMU_VIOMMU_INVALIDATE_DATA_ARM_SMMUV3`.
/// The kernel parses the command opcode and operands.
#[repr(C)]
pub struct IommuViommuArmSmmuv3Invalidate {
    pub cmd: [u64; 2],
}
...
#[repr(C)]
pub struct IommuVdeviceAlloc {
    pub size: u32,
    pub viommu_id: u32,
    pub dev_id: u32,
    pub out_vdevice_id: u32,
    pub virt_id: u64,
}
...
#[repr(C)]
pub struct IommuVeventqAlloc {
    pub size: u32,
    pub flags: u32,
    pub viommu_id: u32,
    pub r#type: u32,
    pub veventq_depth: u32,
    pub out_veventq_id: u32,
    pub out_veventq_fd: u32,
    pub __reserved: u32,
}
